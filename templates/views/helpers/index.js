...
var projectHelpers = require('./helpers');
...
module.exports = function() {
	...
	* */
	...
	for (var key in projectHelpers) {
		if (projectHelpers.hasOwnProperty(key)) {
			if (_helpers[key] !== undefined) {
				console.warn('Helpers: Attempt to override existing helper [' + key + '] by project helper. Project helper not assigned.');
